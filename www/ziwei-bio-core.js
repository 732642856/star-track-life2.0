...
function generateZiweiCharacterBio(userData, chart, attributes, sihuaType) {
    ...
    var crossTurning  = ((STAR_SIHUA_TURNING[mainStar]  || {})[sihuaKeyFull]) || (_lang === 'en' ? 'A defining moment that breaks through the usual defence, forcing a reckoning.' : '某个打破防御的关键事件迫使' + pronoun + '重新审视自己');
    var crossDramatic = ((STAR_SIHUA_DRAMATIC[mainStar] || {})[sihuaKeyFull]) || _getDramaticRole(patternType);
    var crossRival    = ((STAR_RIVAL_STYLE[mainStar]    || {})[patternType])  || (_lang === 'en' ? 'Meets opposition in a uniquely characteristic way.' : '以独特方式应对对手');
